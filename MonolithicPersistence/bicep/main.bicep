...
var sqlDBName = 'monolithicPersistence-${uniqueName}'
var sqlDBNameLog = 'monolithicPersistenceLog-${uniqueName}'
var logAnalyticsWorkspaceName = 'monolithicPersistence-${uniqueName}'
...
resource sqlDBLog 'Microsoft.Sql/servers/databases@2023-08-01-preview' = {
  parent: sqlServer
  name: sqlDBNameLog
  location: location
  sku: {
